...
const vexthonEn = {
  ...
  date: {
    title: "Date",
    description: "From October 19 to October 27",
  },
  news: {
    title: "News",
    description:
      "Registrations are now open for the first edition of the VEX-Thon!",
  },
  ...
  about_vex_thon: {
    ...
    quizs: [
      ...
      },
      {
        ...
        answer:
          "It will take place between October 19 and October 27, offering a flexible schedule to explore your creativity to the fullest.",
      },
      {
    ...
    quizs: [
      {
        ...
        answer:
          "The 1st edition of the VEX-Thon is aimed at students of the Campus Diagonal Besòs of the Polytechnic University of Catalonia. However, in future editions, we plan to accept registrations from other centers and age groups.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Unfortunately, in this first edition, we will only focus on EEBE students, but stay tuned for future editions where we plan to expand our scope.",
      },
    ],
  },
  teams: {
...
function fillContentVexthon() {
  ...
  $("register").innerHTML = contentVexthon.register;
