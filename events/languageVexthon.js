...
const vexthonEn = {
  ...
  networks: "NETWORKS",
  languages: "LANGUAGES",
  firstDescription: "Join the most innovative Robotics Competition",
...
const vexthonCat = {
  ...
  networks: "XARXES",
  languages: "IDIOMES",
  firstDescription: "Participa en la competició de robòtica més innovadora",
...
function hideMobileMenu() {
  ...
  mobileMenu.style.transformStyle = "preserve-3d";
